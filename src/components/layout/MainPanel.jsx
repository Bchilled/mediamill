...
const makeStub=(name,icon)=>function(){
  ...
  return(<div className='flex-1 flex items-center justify-center' style={{color:isDark?'#6B6888':'#888899'}}>
    <div className='text-center'><div className='text-5xl mb-4'>{icon}</div>
    <div className='text-lg font-bold mb-2' style={{color:isDark?'#E8E6FF':'#111122'}}>{name}</div>
    <div className='text-sm'>Sprint 2 — Coming soon</div></div></div>);
};
...
export default function MainPanel(){
  ...
  return(<div className='flex flex-col overflow-hidden' style={{background:isDark?'#080810':'#F0F0F8'}}><TabBar/><View/></div>);
}